...
ros_kortex (Github) (机械臂的ROS 环境): https://github.com/Kinovarobotics/ros_kortex

ros_kortex_vision (Github) (视觉模块的 ROS 环境): https://github.com/Kinovarobotics/ros_kortex_vision

ros2_kortex (Github) (机械臂的ROS2 环境): https://github.com/Kinovarobotics/ros2_kortex

ros2_kortex_vision (Github) (视觉模块的 ROS2 环境): https://github.com/Kinovarobotics/ros2_kortex_vision

GEN3 ROS2 Training (Youtube) (ROS2开发机械臂的视频): https://www.youtube.com/watch?v=Vcb_A1MmC-g&list=PLz1XwEYRuku6z20TaZKKvyB2Y6fSzD5FG&ab_channel=Kinova



其他非官方的文档参考：

KinovaArmController (Github) (个人开发的Kinova机械臂控制项目): https://github.com/Tongyuang/KinovaArmController
